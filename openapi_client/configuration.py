...
DEFAULT_HOST = "https://api.twilio.com"
LOCAL_BASIC_AUTH_HOSTS = {"localhost", "127.0.0.1", "::1"}
...
conf = openapi_client.Configuration(
    ...
    def __init__(self, host=None,
        ...
        """Constructor
        """
        self._base_path = DEFAULT_HOST if host is None else host
        """Default Base url
        """
    ...
    def host_allows_basic_auth(self, host=None):
        ...
        configured_origin = _url_origin(self.host)
        effective_origin = _url_origin(effective_host)
        if effective_origin is None or effective_origin != configured_origin:
            return False
        scheme, hostname, _ = effective_origin
        if scheme == "https":
            return True
        return (
            scheme == "http" and
            hostname in LOCAL_BASIC_AUTH_HOSTS
        )
